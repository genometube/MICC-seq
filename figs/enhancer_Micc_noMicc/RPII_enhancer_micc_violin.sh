...
RPII_bdg=/research/xieyeming1/proj_2025/MICC_paper/peak_hg19/misc/enhancer_gro_stripe_h3k27ac/hek293_RPII_chip.bedgraph
${bedtools} map -a h3k4me1_Micc.bed -b ${RPII_bdg} -c 4 -o mean > RPII_h3k4me1_Micc.bdg
${bedtools} map -a h3k4me1_noMicc.bed -b ${RPII_bdg} -c 4 -o mean > RPII_h3k4me1_noMicc.bdg
