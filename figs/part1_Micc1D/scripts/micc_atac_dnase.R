...
multi_overlap<-bedtoolsr::bt.multiinter(list(hek_micc_10kBin,hek_atac_10kBin,hek_dnase_10kBin),cluster=TRUE)
head(multi_overlap)
cols<-c('hek_micc_10kBin','hek_atac_10kBin','hek_dnase_10kBin')
...
NIH3T3_atac_10kBin<-bedtoolsr::bt.intersect(a=mm10_10kBin,b=NIH3T3_atac,wa=TRUE,u=TRUE,sorted=TRUE)
NIH3T3_dnase_10kBin<-bedtoolsr::bt.intersect(a=mm10_10kBin,b=NIH3T3_dnase,wa=TRUE,u=TRUE,sorted=TRUE)

source("../../../scripts/R_func/eulerr.R")
multi_overlap<-bedtoolsr::bt.multiinter(list(NIH3T3_micc_10kBin,NIH3T3_atac_10kBin,NIH3T3_dnase_10kBin),cluster=TRUE)
head(multi_overlap)
cols<-c('NIH3T3_micc_10kBin','NIH3T3_atac_10kBin','NIH3T3_dnase_10kBin')
...
plot_grid(plot_grid(p_euler_upset_hek$euler, p_euler_upset_NIH3T3$euler, upset_hek_grob, upset_NIH3T3_grob, ncol = 2, labels = c("A", "B")),
  plot_grid(p_violin_hek_micc_vs_atac, p_violin_hek_micc_vs_dnase, ncol = 2, labels = c("C", "D")),nrow = 1)
dev.off()
